...
const OurProductsComponent = () => {
  ...
  const divisionRef = React.useRef<HTMLDivElement>(null);
      ...
      <div className="bg-gray-50 relative">
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-30"></div> */}
            ...
            <div className="text-white left-[6%] top-[25%] absolute z-10 ">
              <h1
                ref={productsRef}
                className="text-white text-4xl md:text-5xl font-bold leading-tight mb-4 drop-shadow-lg"
              >
                Our Products
              </h1>
              <p
                ref={descRef}
                className="text-sm md:text-xl opacity-90 drop-shadow-md"
              >
